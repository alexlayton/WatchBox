...
extension WatchBoxStore {
    ...
    func seed() throws {
        ...
        let responses = try Self.jsonResponses.compactMap { jsonString throws -> OMDBResponse? in
        ...
        try responses.forEach { try addFilm(from: $0) }
    }
    
    private static let jsonResponses: [String] = [
